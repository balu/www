...
We may want to see all replies from follower of a tweeter to a
...
We have seen how a backend for a simple twitter-like application can
be organized in a relational database.
